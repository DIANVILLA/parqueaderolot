        ...
        try {
            ...
            if (response.ok) {
                ...
                if (setUsuarioLogueado) {
                    setUsuarioLogueado(data.usuario || null);
                }
                toast.current.show({ 
    ...
    return (
        <div className="login-container">
            ...
            <button
                ...
                onClick={() => navigate('/')}
            >
                <i className="pi pi-arrow-left icon-inline" />
                Volver al inicio
            </button>
            ...
            <div className="login-box">
                ...
                <form onSubmit={handleLogin} autoComplete="off">
                    ...
                    <div className="field">
                        ...
                        <div className="custom-input-wrapper">
                            ...
                            <InputText 
                                ...
                                className="w-full custom-padding email-lowercase" 
                                placeholder="Usuario"
                            />
                        </div>
                    </div>
                    ...
                    <button
                        type="button"
                        className="btn-cliente-portal"
                        onClick={() => navigate('/cliente')}
                    >
                        PORTAL CLIENTE / RESERVAR CUPO
                    </button>
